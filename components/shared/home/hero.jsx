...
export default function Hero() {
	...
	return (
		<section className='w-full pt-[8.25rem] bg-white flex flex-col gap-6 max-md:py-24 max-md:pt-28 py-32'>
			...
			<div className='flex gap-5 animate-[fadeUp_0.6s_ease-out] flex-wrap justify-center'>
				...
				<Button className='hidden max-md:block' size='dxl'>
					<Link href='https://cdn.slipe.fun/site/static/app/slipe-1.3.2.apk'>Try app</Link>
				</Button>
				<Button size='dxl'>
